...
export default async function SettingsDetailsPage({ params }: SettingsDetailsPageProps) {
  ...
  return (
    <SettingsPlaceholder
      ...
      description="Modifier les informations générales de la pharmacie : nom, adresse, contacts et informations administratives."
    />
  );
}
