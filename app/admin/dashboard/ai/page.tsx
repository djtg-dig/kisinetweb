...
//
// Page d'accueil de la section « IA », accessible via l'onglet « Statistique IA »
// de la barre latérale admin (/admin/dashboard/ai). Toutes les données
// proviennent de GET /api/admin/ai/dashboard/ et /alerts/, réservés aux
